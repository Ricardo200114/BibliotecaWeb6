...
<html>
    ...
    <body>
        ...
        <div id="msj" class="${config}" role="alert">
            ...
            <div class="back4">
                <div class="titulo"><h1 class="text-center mb-5 text-white" style=" font-weight: bold;">Préstamo de CDs</h1></div>
                <div class="container block1">
                    <div class="card col-sm-12 bg-light">
                        <div class="card-body">
                            <form action="PrestarControlador?menu=PrestarCds&noCarnet=${us.getNoCarnet()}" method="POST">
                                <div class="form-group">
                                    <label>No de Carnet:</label>
                                    <input type="text" name="txtCarnet" class="form-control" required="true">
                                </div>
                                <div class="form-group">
                                    <label>Código de CD:</label>
