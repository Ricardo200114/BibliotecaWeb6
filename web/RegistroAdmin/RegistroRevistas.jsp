...
<html>
    ...
    <body>
        ...
        <h3 class="text-center m-4" style=" font-weight: bold;">Registro de Revistas</h3>

        <div class="d-flex">
            <div class="col-12 bg-light">
                <div class="card bg-light">
                    <form action="RevistaControlador?menu=Revista&noCarnet=${us.getNoCarnet()}" method="POST">
                        <div class="card-body">

                            <div class="form-group d-flex">

                                <div class="col-lg-2">
                                    <input type="text" name="txtCod" placeholder="Código revista" value="${re.getCodRe()}" class="form-control" required="true">
                                </div>
                                <div class="col-lg-2">
                                    <input type="text" name="txtTitulo" placeholder="Titulo" value="${re.getTitulo()}" class="form-control" required="true">
                                </div>
                                <div class="col-lg-2">
                                    <input type="text" name="txtEditorial" placeholder="Editorial" value="${re.getEditorial()}" class="form-control" required="true">
                                </div>
                                <div class="col-lg-2">
                                    <input type="text" name="txtIsbn" placeholder="ISBN" value="${re.getIsbn()}" class="form-control" required="true">
                                </div>
                                <div class="col-lg-2">
                                    <input type="text" name="txtPeriodicidad" placeholder="Periodicidad" value="${re.getPeriodicidad()}" class="form-control" required="true">
                                </div>
                            </div>

                            <div class="form-group d-flex">
                                <div class="col-lg-2">
                                    <input type="text" name="txtFecha" placeholder="Fecha publicación" value="${re.getFecha()}" class="form-control" required="true">
                                </div>
                                <div class="col-lg-2">
                                    <input type="text" name="txtTamanio" placeholder="Tamaño" value="${re.getTamanio()}" class="form-control" required="true">
                                </div>
                                <div class="col-lg-2">
                                    <input type="text" name="txtIdioma" placeholder="Idioma" value="${re.getIdioma()}" class="form-control" required="true">
                                </div>
                                <div class="col-lg-2">
                                    <input type="text" name="txtUbicacion" placeholder="Ubicación" value="${re.getUbicacion()}" class="form-control" required="true">
                                </div>
                                <div class="col-lg-2">
                                    <input type="number" name="txtUnidad" placeholder="Unidades" value="${re.getUnidades()}" class="form-control" required="true">
                                </div>
                                <div class="col-lg-1">
                        ...
                        <tbody>
                            <c:forEach var="rev" items="${lista}">
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-warning" href="RevistaControlador?menu=Revista&accion=Editar&CodRe=${rev.getCodRe()}&noCarnet=${car}">Editar</a>
                                        <a class="btn btn-danger" href="RevistaControlador?menu=Revista&accion=Eliminar&CodRe=${rev.getCodRe()}&noCarnet=${car}">Eliminar</a>
                                    </td>
                                </tr>  
                            </c:forEach>    
                        </tbody>
