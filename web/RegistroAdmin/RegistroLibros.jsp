...
<html>
    ...
    <body>
        ...
        <h3 class="text-center m-4" style=" font-weight: bold;">Registro de Libros</h3>

        <div class="d-flex">
            <div class="col-12">
                <div class="card bg-light">
                    <form action="LibroControlador?menu=Libro&noCarnet=${us.getNoCarnet()}" method="POST">
                        <div class="card-body">
                            <div class="form-group d-flex">

                                <div class="col-lg-2">
                                    <input type="text" name="txtCod" placeholder="Código libro" value="${li.getCodLib()}" class="form-control" required="true">
                                </div>
                                <div class="col-lg-2">
                                    <input type="text" name="txtTitulo" placeholder="Titulo" value="${li.getTitulo()}" class="form-control" required="true">
                                </div>
                                <div class="col-lg-2">
                                    <input type="text" name="txtAutor" placeholder="Autor" value="${li.getAutor()}" class="form-control" required="true">
                                </div>
                                <div class="col-lg-2">
                                    <input type="number" name="txtPagina" placeholder="No Páginas" value="${li.getNoPaginas()}" class="form-control" required="true">
                                </div>
                                <div class="col-lg-2">
                                    <input type="text" name="txtEditorial" placeholder="Editorial" value="${li.getEditorial()}" class="form-control" required="true">
                                </div>
                                <div class="col-lg-2">
                                    <input type="text" name="txtPais" placeholder="País" value="${li.getPais()}" class="form-control" required="true">
                                </div>
                            ...
                            <div class="form-group d-flex">
                                ...
                                <div class="col-lg-2">
                                    <input type="text" name="txtIsbn" placeholder="ISBN" value="${li.getIsbn()}" class="form-control" required="true">
                                </div>
                                <div class="col-lg-2">
                                    <input type="text" name="txtAnio" placeholder="Año publicación" value="${li.getAnioPublicacion()}" class="form-control" required="true">
                                </div>
                                <div class="col-lg-2">
                                    <input type="text" name="txtIdioma" placeholder="Idioma" value="${li.getIdioma()}" class="form-control" required="true">
                                </div>
                                <div class="col-lg-2">
                                    <input type="text" name="txtUbicacion" placeholder="Ubicación" value="${li.getUbicacion()}" class="form-control" required="true">
                                </div>
                                <div class="col-lg-2">
                                    <input type="number" name="txtUnidad" placeholder="Unidades" value="${li.getUnidades()}" class="form-control" required="true">
                                </div>
                                <div class="col-lg-1">
                        ...
                        <tbody>
                            <c:forEach var="lib" items="${lista}">
                                <tr>
                                    ...
                                    <td>${lib.getTitulo()}</td>
                                    <td>${lib.getAutor()}</td>
                                    <td>${lib.getNoPaginas()}</td>
                                    <td>${lib.getEditorial()}</td>
                                    <td>${lib.getPais()}</td>
                                    <td>${lib.getIsbn()}</td>
                                    <td>${lib.getAnioPublicacion()}</td>
                                    <td>${lib.getIdioma()}</td>
                                    <td>${lib.getUbicacion()}</td>
                                    <td>${lib.getUnidades()}</td>
                                    <td>
                                        <a class="btn btn-warning" href="LibroControlador?menu=Libro&accion=Editar&CodLi=${lib.getCodLib()}&noCarnet=${car}">Editar</a>
                                        <a class="btn btn-danger" href="LibroControlador?menu=Libro&accion=Eliminar&CodLi=${lib.getCodLib()}&noCarnet=${car}">Eliminar</a>
                                    </td>
                                </tr>  
                            </c:forEach>    
                        </tbody>
