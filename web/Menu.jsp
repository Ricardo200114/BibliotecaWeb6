                ...
                <div class="row text-center abc">
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 mb-4">
                        <div class="card">
                            ...
                            <div class="contenido d-grid">
                                    <a class="btn btn-dark" href="PrestarUsuarios?menu=PrestarLib&accion=Listar&noCarnet=${us.getNoCarnet()}" role="button">Libros</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 mb-4">
                        <div class="card">
                            ...
                            <div class="contenido d-grid">
                                <a class="btn btn-dark" href="PrestarUsuarios?menu=PrestarObr&accion=Listar&noCarnet=${us.getNoCarnet()}" role="button">Obras</a>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 mb-4">
                        <div class="card">
                            ...
                            <div class="contenido d-grid">
                                <a class="btn btn-dark" href="PrestarUsuarios?menu=PrestarRev&accion=Listar&noCarnet=${us.getNoCarnet()}" role="button">Revistas</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 mb-4">
                        <div class="card">
                            ...
                            <div class="contenido d-grid">
                                <a class="btn btn-dark" href="PrestarUsuarios?menu=PrestarCds&accion=Listar&noCarnet=${us.getNoCarnet()}" role="button">CD´s</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 mb-4">
                        <div class="card">
                            ...
                            <div class="contenido d-grid">
                                <a class="btn btn-dark" href="PrestarUsuarios?menu=PrestarTsi&accion=Listar&noCarnet=${us.getNoCarnet()}" role="button">Tesis</a>
                            </div>
                        </div>
                    </div>               
                </div>
                ...
                <div class="row text-center">
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 mb-4">
                        <div class="card">
                            ...
                            <div class="contenido d-grid">
                                <a class="btn btn-dark" href="DevolverUsuarios?menu=Devolver&accion=Listar&noCarnet=${us.getNoCarnet()}" role="button">Devolver Material</a>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 mb-4">
                        <div class="card">
                            ...
                            <div class="contenido d-grid">
                                <a class="btn btn-dark" href="UsuarioControlador?menu=PagarUsuarioMora&accion=Listar&noCarnet=${us.getNoCarnet()}" role="button">Pagar Recargo</a>
