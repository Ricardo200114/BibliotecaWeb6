            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu text-center">
                    <a class="dropdown-item" href="#">
                        <img src="Resources/images/user1.png" alt="60" width="60"/>
                    </a>
            ...
            <div class="back7">
                ...
                <div class="container block1">
                    <div class="card col-sm-12 bg-light">
                        <div class="card-body">
                            <form action="UsuarioControlador?menu=PagarUsuarioMora" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" name="txtPago" class="form-control" required="true">
                                </div>
                                <input type="submit" name="accion" value="Pagar" class="btn btn-dark">
                            </form>
                        </div>
                    </div>
                </div> 
