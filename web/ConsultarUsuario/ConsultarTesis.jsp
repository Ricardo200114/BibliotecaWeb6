...
<html>
    ...
    <body>
      ...
      <img src="Resources/images/udb.png" alt="" width="40" height="34">
        ...
        <div class="back5">
            <div class="titulo"><h1 class="text-center mb-5 text-white" style=" font-weight: bold;">Formulario de Consulta de Tesis</h1></div>
            <div class="container block1">
                <div class="card col-sm-12 col-lg-9 bg-light">
                    <div class="card-body">
                        <form action="ConsultarUsuarios?menu=ConsultarTsi" method="POST">
...
<br>
  ...
  <footer class="bg-dark text-light text-center p-3">
    <div class="container">
      <p>&copy; 2023 BIBLIOTECA UDB. Todos los derechos reservados.</p>
    </div>
  </footer>
