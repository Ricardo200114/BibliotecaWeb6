...
<html>
    ...
    <body>
        ...
        <div id="msj" class="${config}" role="alert">
            ...
            <div class="back6">
                <div class="titulo"><h1 class="text-center mb-5 text-white" style=" font-weight: bold;">Devolución de materiales</h1></div>
                <div class="container block1">
                    <div class="card col-sm-12 bg-light">
                        <div class="card-body">
                            <form action="DevolverUsuarios?menu=Devolver" method="POST">

                                <div class="form-group">
                                    <label>No de Carnet:</label>
                                    <input type="text" name="txtCarnet" value="${c}" class="form-control" readonly="true" required="true">
                                </div>
                                <div class="form-group">
