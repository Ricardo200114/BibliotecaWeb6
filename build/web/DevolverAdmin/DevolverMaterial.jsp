...
<html>
    ...
    <body>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="PrestarControlador?menu=PrestarCds&accion=Listar&noCarnet=${us.getNoCarnet()}">CD´s</a>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="CdControlador?menu=CD&accion=Listar&noCarnet=${us.getNoCarnet()}">CD´s</a>
        ...
        <div id="msj" class="${config}" role="alert">
            ...
            <div class="back6">
                <div class="titulo">
                    <h1 class="text-center mb-5 text-white" style="font-weight: bold;">Préstamo de Libros</h1>
                </div>
                <div class="container block1">
                    <div class="card col-sm-12 bg-light">
                        <div class="card-body">
                            <form action="DevolverControlador?menu=Devolver&noCarnet=${us.getNoCarnet()}" method="POST">
                                ...
                                <input type="submit" name="accion" value="Devolver" class="btn btn-dark">
                            </form>
                        </div>
                    </div>
                </div>
            ...
            <div class="container-sm table-responsive block2">
                <div class="col-sm-12 text-center">
                    <table class="table table-hover table-striped" style="background-color: lightgray;">
                        ...
                        <tbody>
                            <c:forEach var="mat" items="${lista}">
                                <tr>
                                    <td>${mat.getNoCarnet()}</td>
                                    <td>${mat.getNombre()}</td>
                                    <td>${mat.getCodMaterial()}</td>
                                    <td>${mat.getMaterial()}</td>
                                    <td>${mat.getF_prestamo()}</td>
                                    <td>${mat.getF_devolucion()}</td>
                                </tr>
                            </c:forEach>
                        </tbody>
                    </table>
