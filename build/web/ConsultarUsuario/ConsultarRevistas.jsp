...
<html>
    ...
    <body>
      ...
      <img src="Resources/images/udb.png" alt="" width="40" height="34">
        ...
        <div class="back3">
            <div class="titulo"><h1 class="text-center mb-5 text-white" style=" font-weight: bold;">Formulario de Consulta de Revistas</h1></div>
            <div class="container block1">
                <div class="card col-sm-12 bg-light">
                    <div class="card-body">
                        <form action="ConsultarUsuarios?menu=ConsultarRev" method="POST">
