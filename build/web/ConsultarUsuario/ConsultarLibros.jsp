...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <img src="Resources/images/udb.png" alt="" width="40" height="34">
        ...
        <div class="back1">
            <div class="titulo"><h1 class="text-center mb-5 text-white" style=" font-weight: bold;">Formulario de Consulta de Libros</h1></div>
            <div class="container block1">
                <div class="card col-sm-12 col-lg-9 bg-light">
                    <div class="card-body">
                        <form action="ConsultarUsuarios?menu=ConsultarLib" method="POST">
