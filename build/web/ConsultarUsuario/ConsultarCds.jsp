...
<html>
    ...
    <body>
      ...
      <img src="Resources/images/udb.png" alt="" width="40" height="34">
        ...
        <div class="back4">
            <div class="titulo"><h1 class="text-center mb-5 text-white fw-bold" style=" font-weight: bold;">Formulario de Consulta de CD's</h1></div>
            <div class="container block1 mx-auto">
                <div class="card col-sm-12 col-lg-9 bg-light">
                    <div class="card-body">
                        <form action="ConsultarUsuarios?menu=ConsultarCds" method="POST">
