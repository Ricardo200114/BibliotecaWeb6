...
<html>
    ...
    <body>
        ...
        <h3 class="text-center m-4" style=" font-weight: bold;">Registro de Tesis</h3>

        <div class="d-flex">
            <div class="col-12">
                <div class="card bg-light">
                    <form action="TesisControlador?menu=Tesis&noCarnet=${us.getNoCarnet()}" method="POST">
                        <div class="card-body">

                            <div class="form-group d-flex">

                                <div class="col-lg-2">
                                    <input type="text" name="txtCod" placeholder="Código tesis" value="${ts.getCodTs()}" class="form-control" required="true">
                                </div>
                                <div class="col-lg-2">
                                    <input type="text" name="txtTitulo" placeholder="Titulo" value="${ts.getTitulo()}" class="form-control" required="true">
                                </div>
                                <div class="col-lg-2">
                                    <input type="text" name="txtAutor" placeholder="Autor" value="${ts.getAutor()}" class="form-control" required="true">
                                </div>
                                <div class="col-lg-2">
                                    <input type="text" name="txtPais" placeholder="País" value="${ts.getPais()}" class="form-control" required="true">
                                </div>
                                <div class="col-lg-2">
                                    <input type="text" name="txtCiudad" placeholder="Ciudad" value="${ts.getCiudad()}" class="form-control" required="true">
                                </div>
                                <div class="col-lg-2">
                                    <input type="text" name="txtUniversidad" placeholder="Universidad" value="${ts.getUniversidad()}" class="form-control" required="true">
                                </div>
                            ...
                            <div class="form-group d-flex">
                                ...
                                <div class="col-lg-2">
                                    <input type="number" name="txtPagina" placeholder="No Páginas" value="${ts.getNoPagina()}" class="form-control" required="true">
                                </div>
                                <div class="col-lg-2">
                                    <input type="text" name="txtFecha" placeholder="Fecha publicación" value="${ts.getFecha()}" class="form-control" required="true">
                                </div>
                                <div class="col-lg-2">
                                    <input type="text" name="txtIdioma" placeholder="Idioma" value="${ts.getIdioma()}" class="form-control" required="true">
                                </div>
                                <div class="col-lg-2">
                                    <input type="text" name="txtUbicacion" placeholder="Ubicación" value="${ts.getUbicacion()}" class="form-control" required="true">
                                </div>
                                <div class="col-lg-2">
                                    <input type="number" name="txtUnidad" placeholder="Unidades" value="${ts.getUnidades()}" class="form-control" required="true">
                                </div>
                                <div class="col-lg-1">
                        ...
                        <tbody>
                            <c:forEach var="tsi" items="${lista}">
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-warning" href="TesisControlador?menu=Tesis&accion=Editar&CodTs=${tsi.getCodTs()}&noCarnet=${car}">Editar</a>
                                        <a class="btn btn-danger" href="TesisControlador?menu=Tesis&accion=Eliminar&CodTs=${tsi.getCodTs()}&noCarnet=${car}">Eliminar</a>
                                    </td>
                                </tr>  
                            </c:forEach>    
                        </tbody>
