...
<html>
    ...
    <body>
        ...
        <h3 class="text-center m-4" style=" font-weight: bold;">Registro de Usuarios</h3>
  
        <div class="container d-flex">
            <div class="col-12">
                <div class="card bg-light">
                    <form action="UsuarioControlador?menu=Usuario&noCarnet=${us.getNoCarnet()}" method="POST">
                        <div class="card-body">
                            <div class="form-group d-flex">
                                <div class="col-lg-3">
                                    <label>No Carnet</label>
                                    <input type="text" name="txtCarnet"  value="${user.getNoCarnet()}" class="form-control" required="true">
                                </div>
                                <div class="col-lg-3">
                                    <label>Nombre</label>
                                    <input type="text" name="txtNombre"  value="${user.getNombre()}" class="form-control" required="true">
                                </div>
                                <div class="col-lg-3">
                                    <label>Apellido</label>
                                    <input type="text" name="txtApellido"  value="${user.getApellido()}" class="form-control" required="true">
                                </div>
                            ...
                            <div class="form-group d-flex">
                                <div class="col-lg-3">
                                    <label>Oficio</label>
                                    <input type="text" name="txtOficio"  value="${user.getOficio()}" class="form-control" required="true">
                                </div>
                                <div class="col-lg-3">
                                    <label>Username</label>
                                    <input type="text" name="txtUsername"  value="${user.getUsername()}" class="form-control" required="true">
                                </div>
                                <div class="col-lg-3">
                                    <label>Contraseña</label>
                                    <input type="password" name="txtPass"  value="${user.getPassword()}" class="form-control" required="true">
                                </div>
                                <div class="col-lg-3 "  >
                    ...
                    <table class="table table-hover table-striped" style="background-color: lightgray;">
                        ...
                        <tbody>
                            <c:forEach var="us" items="${lista}">
                                <tr>
                                    <td>${us.getNoCarnet()}</td>
                                    <td>${us.getNombre()}</td>
                                    <td>${us.getApellido()}</td>
                                    <td>${us.getOficio()}</td>
                                    <td>${us.getUsername()}</td>
                                    <td>${us.getRecargoMora()}</td>
                                    <td>
                                        <a class="btn btn-warning" href="UsuarioControlador?menu=Usuario&accion=Editar&NoCarnet=${us.getNoCarnet()}&noCarnet=${car}">Editar</a>
                                        <a class="btn btn-danger" href="UsuarioControlador?menu=Usuario&accion=Eliminar&NoCarnet=${us.getNoCarnet()}&noCarnet=${car}">Eliminar</a>
                                    </td>
                                </tr>  
                            </c:forEach>    
                        </tbody>
