...
<html>
    ...
    <body>
        ...
        <div id="msj" class="${config}" role="alert">
            ...
            <div class="back7">
                <div class="titulo"><h1 class="text-center mb-5 text-white" style=" font-weight: bold;">Pago de Recargo</h1></div>
                <div class="container block1">
                    <div class="card col-sm-12 bg-light">
                        <div class="card-body">
                            <form action="UsuarioControlador?menu=PagarMora&noCarnet=${us.getNoCarnet()}" method="POST">
