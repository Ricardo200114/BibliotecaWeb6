...
<html>
    ...
    <body>
        ...
        <div id="msj" class="${config}" role="alert">
            ...
            <div class="back1">
                <div class="titulo"><h1 class="text-center mb-5 text-white" style=" font-weight: bold;">Préstamo de Libros</h1></div>
                <div class="container block1">
                    <div class="card col-sm-12 bg-light">
                        <div class="card-body">
                            <form action="PrestarUsuarios?menu=PrestarLib" method="POST">
                                <div class="form-group">
                                    <label for="txtCarnet">No Carnet:</label>
                                    <input type="text" name="txtCarnet" value="${c}" class="form-control" readonly="true">
                                </div>

                                <div class="form-group">
                                    <label for="txtCod">Código de libro:</label>
